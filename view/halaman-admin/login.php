<?php 
  ...
  if (isset($_SESSION['idne'])) {
    header('Location: ../../view/halaman-admin/index.php');
  }
?>
<!DOCTYPE html>
<html lang="en">
         ...
         <div class="container mt-5">
            <div class="row">
               <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                  <div class="login-brand">
                     <a href="../halaman"><img src="../../assets/img/stmik/stmiklogo.png" alt="logo" width="100"
                           class=""></a>
                  </div>
            ...
            ?>
                  ...
                  <div class="card card-primary">
                     ...
                     <div class="card-body">
                        <form method="POST" action="../../controller/admin/login-admin-control.php"
                           ...
                           <div class="form-group text-right">
                              ...
                              <button type="submit" name="loginData" class="btn btn-primary btn-lg btn-icon icon-right"
                                 tabindex="4">
                                 Login
                              </button>
                           </div>
