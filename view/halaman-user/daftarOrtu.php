...
<?php
	session_start();
	$title = "Pendaftaran Mahasiswa Baru"; // Judulnya
...
<head>
   ...
   <title><?= $title; ?> | PMB</title>
   <link rel="icon" href="../../assets/img/stmik/stmiklogo.png">
         ...
         <nav class="navbar navbar-expand-lg main-navbar">
            ...
            <ul class="navbar-nav navbar-right">
               ...
               <li class="dropdown"><a href="#" data-toggle="dropdown"
                     ...
                     <img alt="image" src="../../assets/img/dosen/avatar-1.png" class="rounded-circle mr-1">
                     <div class="d-sm-none d-lg-inline-block"><?= $_SESSION['namaPeserta']; ?></div>
                  </a>
                  <div class="dropdown-menu dropdown-menu-right">
                     <!-- <div class="dropdown-title">Logged in 5 min ago</div> -->
                     <a href="../../controller/user/daftar-control.php?logout"
         ...
         <div class="main-sidebar">
            <aside id="sidebar-wrapper">
               <div class="sidebar-brand">
                  <a href=""><img src="../../assets/img/stmik/stmiklogo.png" width="30px"></a>
               </div>
               <div class="sidebar-brand sidebar-brand-sm">
                  <a href=""><img src="../../assets/img/stmik/stmiklogo.png" width="47px"></a>
               </div>
                  ...
                  <div class="row">
                        ...
                        <div class="card">
                           <div class="card-header">
                              ...
                              <a href="login.php" type="button"
                                 ...
                                 <i class="fas fa-arrow-left"></i> Halaman Login
                              </a>
                           </div>
                           <div class="card-body">
                              ...
                              <form class="needs-validation" novalidate=""
                                 action="../../controller/user/daftar-control.php" method="POST">
	          	  ...
	          	  ?>
                                       <input type="text" class="form-control" required=""
                                          value="<?= $_SESSION['nisnPeserta'] ?> | <?= $_SESSION['namaPeserta'] ?>"
                                          disabled>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <textarea type="text" class="form-control" name="alamat_ayah" required=""
                                    ...
                                    <div class="form-group">
                                       ...
                                       <textarea type="text" class="form-control" name="alamat_ibu" required=""
                                          style="height:80px"></textarea>
                                       <!-- Validation -->
                                       <div class="valid-feedback"> Baguss! </div>
                                       <div class="invalid-feedback"> Wajib Diisi! </div>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <textarea type="text" class="form-control" name="alamat_wali" required=""
                                          style="height:80px"></textarea>
                                       <!-- Validation -->
                                       <div class="valid-feedback"> Baguss! </div>
                                       <div class="invalid-feedback"> Wajib Diisi! </div>
          	...
          	?>
	          	  ...
	          	  ?>
                                    ...
                                    <div class="form-group">
                                       <label>Pendidikan Terakhir Ayah</label>
                                       <input type="text" class="form-control" name="pendidikan_terakhir_ayah"
                                          required="" value="<?= $row['Pendidikan_Terakhir_Ayah'] ?>">
                                       <!-- Validation -->
                                       <div class="valid-feedback"> Baguss! </div>
                                       <div class="invalid-feedback"> Wajib Diisi! </div>
                                       <!-- End Validation -->
                                    ...
                                    <div class="form-group">
                                       <label>Alamat Ayah</label>
                                       <textarea type="text" class="form-control" name="alamat_ayah" required=""
                                          style="height:80px"><?= $row['Alamat_Ayah'] ?></textarea>
                                       <!-- Validation -->
                                       <div class="valid-feedback"> Baguss! </div>
                                       <div class="invalid-feedback"> Wajib Diisi! </div>
                                       <!-- End Validation -->
                                    ...
                                    <div class="form-group">
                                       <label>Pendidikan Terakhir Ibu</label>
                                       <input type="text" class="form-control" name="pendidikan_terakhir_ibu"
                                          required="" value="<?= $row['Pendidikan_Terakhir_Ibu'] ?>">
                                       <!-- Validation -->
                                       <div class="valid-feedback"> Baguss! </div>
                                       <div class="invalid-feedback"> Wajib Diisi! </div>
                                       <!-- End Validation -->
                                    ...
                                    <div class="form-group">
                                       <label>Alamat Ibu</label>
                                       <textarea type="text" class="form-control" name="alamat_ibu" required=""
                                          style="height:80px"><?= $row['Alamat_Ibu'] ?></textarea>
                                       <!-- Validation -->
                                       <div class="valid-feedback"> Baguss! </div>
                                       <div class="invalid-feedback"> Wajib Diisi! </div>
                                       <!-- End Validation -->
                                    ...
                                    <div class="form-group">
                                       <label>Pendidikan Terakhir Wali</label>
                                       <input type="text" class="form-control" name="pendidikan_terakhir_wali"
                                          required="" value="<?= $row['Pendidikan_Terakhir_Wali'] ?>">
                                       <!-- Validation -->
                                       <div class="valid-feedback"> Baguss! </div>
                                       <div class="invalid-feedback"> Wajib Diisi! </div>
                                       <!-- End Validation -->
                                    ...
                                    <div class="form-group">
                                       <label>Penghasilan Wali</label>
                                       <input type="text" class="form-control" name="penghasilan_wali" required=""
                                          value="<?= $row['Penghasilan_Wali'] ?>">
                                       <!-- Validation -->
                                       <div class="valid-feedback"> Baguss! </div>
                                       <div class="invalid-feedback"> Wajib Diisi! </div>
                                       <!-- End Validation -->
                                    ...
                                    <div class="form-group">
                                       <label>Alamat Wali</label>
                                       <textarea type="text" class="form-control" name="alamat_wali" required=""
                                          style="height:80px"><?= $row['Alamat_Wali'] ?></textarea>
                                       <!-- Validation -->
                                       <div class="valid-feedback"> Baguss! </div>
                                       <div class="invalid-feedback"> Wajib Diisi! </div>
                                       <!-- End Validation -->
      ...
      <footer class="main-footer">
         <div class="row">
            <div class="col-4 text-center">
               Copyright &copy; 2018 <div class="bullet"></div> <br> Design By <a href="https://nauval.in/">Muhamad
                  Nauval
                  Azhar</a>
            </div>
            <div class="col-4 text-center">
               Modify By <br>
               <a href="https://www.instagram.com/erimaulana.69/" class="text-dark">Eri Maulana</a>
               &
               <a href="https://www.instagram.com/narila_putnar02/" class="text-dark">Putri Narila</a>
            </div>
            <div class="col-4 text-center">
               Developer By <br> <a href="//linkedin.com/in/bejosuseno" target="blank">Code Peka</a>
            </div>
         </div>
      </footer>
   </div>
