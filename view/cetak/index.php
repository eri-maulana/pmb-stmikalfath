...
<head>
   <title>Cetak Kartu Calon Peserta|PMB</title>
...
<body style="width: 900px; font-family: unset;">
   ...
   <div class="container-fluid">
      <p style="font-size: 15px;font-weight: bold;text-align: center; width: 800px;">
         STMIK AL FATH <br>
         Jl. Otto Iskandardinata No.23, Kebonjati, Kec. Cikole, Kota Sukabumi, Jawa Barat 43112<br>
         No. Telp : (0266) 6245391
      </p>
      <br>
      ...
      <div class="row">
         <div class="col-md-6">
            Identitas Calon Mahasiswa Baru: <br><br>
            <table>
               <tr>
         ...
         <div class="col-md-6">
            Identitas Orang Tua Calon Mahasiswa Baru: <br><br>
            <table>
               <tr>
      ...
      <div class="container">
         <div class="row container">
            <div class="col-md-6" style="font-size: 30px; ">
               <?php if ($row['harga'] != NULL) { echo 'Rp. '; } echo $row['harga']; ?></div>
            <div class="col-md-6" style="font-size: 20px;">
               <p style="border-style: double; text-align: center; width: 280px; padding: 5px;">
                  <?php if ($row['status'] == NULL) { echo 'Belum Lunas'; } echo $row['status']; ?></p>
            </div>
         </div>
      </div>
      <?php } ?>
