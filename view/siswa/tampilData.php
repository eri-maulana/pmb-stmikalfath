                  ...
                  ?>
                           <tr>
                              ...
                              <td class="text-center" width="120px">
                                 <a href="ubahData.php?id=<?= $row['Id_Identitas_Siswa']; ?>" class="btn btn-warning"><i
                                       class="fas fa-pencil-alt"></i></a>
                                 <a href="../../controller/admin/siswa.php?hapusData=<?= $row['Id_Identitas_Siswa']; ?>"
                                    class="btn btn-danger my-2" onclick="return confirm('Anda Yakin');"><i
